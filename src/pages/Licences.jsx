         ...
         <div className="licence-section__grid">
            {[1, 2].map((_, i) => (
               ...
               <div className="licence-card__buttons">
                  <button className="licence-card__btn licence-card__btn--view">Посмотреть</button>
                  <button className="licence-card__btn licence-card__btn--download">⬇ Скачать</button>
               </div>
               </div>
            ))}
         </div>
